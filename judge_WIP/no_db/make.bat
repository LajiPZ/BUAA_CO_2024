...
java -jar .\mars\mars.jar mc CompactDataAtZero a dump .text HexText code.txt .\mars\testCode.asm > nul
java -jar .\mars\mars.jar mc CompactDataAtZero nc coL1 ./mars/testCode.asm > mars_out.txt 
