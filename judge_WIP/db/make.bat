...
java -jar .\mars\mars.jar db mc CompactDataAtZero a dump .text HexText code.txt .\mars\testCode.asm > nul
java -jar .\mars\mars.jar db mc CompactDataAtZero nc ig coL1 ./mars/testCode.asm > mars_out.txt 
